...
public class Control implements Observer {
	...
	private Double operand = null;	// Repr�sentation von Text und zweiter Operand
	private DoubleBinaryOperator operation = Calc::equation;	// n�chste Operation
	...
	// Die naechste Operation wird gesetzt.
